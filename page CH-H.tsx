  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#020805] text-white">
      ...
      <div className="relative mx-auto min-h-screen max-w-6xl px-6 py-10 sm:px-10">
        {/* Small tech labels */}
        <div className="absolute left-8 top-12 hidden text-[10px] font-semibold leading-5 tracking-[0.2em] text-green-500/60 sm:block">
          WEBSITES
          <br />
          PERFORMANCE
          <br />
        ...
        <div className="absolute right-8 top-12 hidden text-right text-[10px] font-semibold leading-5 tracking-[0.2em] text-green-500/60 sm:block">
          SCAN
          <br />
          DETECT
          <br />
        ...
        <header className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-5 text-xs font-semibold uppercase tracking-[0.22em] text-green-100/70 sm:text-sm">
            Check your website for broken links, images, and videos
          </p>

          <p className="mt-4 text-xs font-bold tracking-[0.18em] text-green-400">
        ...
        <section className="mx-auto mt-14 max-w-4xl">
          ...
          <div className="rounded-[28px] border border-green-500/50 bg-black/70 p-3 shadow-[0_0_35px_rgba(0,255,80,0.12)]">
            <div className="rounded-[20px] border border-green-400/70 p-2">
                ...
                {(["LINK", "IMAGE", "VIDEO"] as CheckerType[]).map(
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-xl px-3 py-4 text-sm font-black tracking-[0.18em] transition-all ${
                        selected
              ...
              <button
                ...
                disabled={checking}
                className={`mt-2 w-full rounded-xl px-3 py-4 text-sm font-black tracking-[0.18em] transition-all ${
                  activeTab === "ULTIMATE"
                    ? "bg-gradient-to-r from-green-400 to-emerald-300 text-black shadow-[0_0_30px_rgba(0,255,80,0.45)]"
            ...
            <div className="mt-4 rounded-[22px] border border-green-500/50 bg-[#031009]/90 p-6 shadow-[inset_0_0_30px_rgba(0,255,80,0.06)] sm:p-8">
              <label
                htmlFor="website"
                className="mb-3 block text-sm font-bold tracking-wide text-green-300"
              >
                URL
              </label>
              ...
              <div className="flex overflow-hidden rounded-2xl border border-green-400/80 bg-black shadow-[0_0_25px_rgba(0,255,80,0.12)]">
                ...
                <input
                  ...
                  className="min-w-0 flex-1 bg-transparent px-5 py-5 text-base text-white outline-none placeholder:text-green-100/30 disabled:opacity-60"
                />
              </div>
              ...
              <button
                ...
                className="mt-5 flex w-full items-center justify-center gap-4 rounded-2xl bg-gradient-to-r from-green-400 to-emerald-300 px-6 py-5 text-lg font-black tracking-[0.12em] text-black shadow-[0_0_35px_rgba(0,255,80,0.35)] transition hover:scale-[1.01] hover:shadow-[0_0_50px_rgba(0,255,80,0.55)] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
              >
            ...
            <div className="mt-8 overflow-hidden rounded-[28px] border border-green-500/50 bg-black/80 shadow-[0_0_35px_rgba(0,255,80,0.1)]">
              <div className="flex items-center justify-between border-b border-green-500/30 px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-sm font-black tracking-[0.2em] text-green-300">
                    LIVE{" "}
                    {
                      activeTab
                    }{" "}
              ...
              <div
                className={`overflow-hidden px-5 py-5 font-mono text-[11px] leading-5 sm:text-xs ${
                  complete
                    ? "min-h-[250px]"
                    : "h-[150px]"
                }`}
              >
                ...
                {complete && (
                  <div className="space-y-3">
                    <div className="mb-4 text-sm font-black tracking-[0.15em] text-green-300">
                      ╔════════════════════════════════════╗
                      <br />
                      ║ &nbsp; SCAN COMPLETE
                      <br />
                              ...
                              return (
                                ...
                                >
                                  <div className="mb-2 flex items-center justify-between">
                                    ...
                                    <span className="text-[9px] font-bold tracking-[0.14em] text-green-500/70">
                                      ULTIMATE SCAN
                                    </span>
                                  </div>
          ...
          <div className="mt-8 rounded-[28px] border border-green-500/50 bg-black/70 p-6 shadow-[0_0_35px_rgba(0,255,80,0.1)] sm:p-8">
            <div className="mb-6 flex items-center gap-4">
              ...
              <h2 className="text-2xl font-black tracking-[0.08em] text-green-300">
                RESULTS
              </h2>
            </div>
            ...
            {complete &&
              ...
              brokenCount > 0 && (
                <div className="mb-6 rounded-2xl border border-green-400/60 bg-green-400/5 px-5 py-4 text-center shadow-[0_0_30px_rgba(0,255,80,0.12)]">
                  ...
                  <div className="mt-1 text-[10px] font-bold tracking-[0.2em] text-green-500">
                    ...
                    >
                      <div className="mb-5 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] font-bold tracking-[0.16em] text-green-500/60">
                              ULTIMATE SCAN
                            </p>
                          </div>
                        </div>

                        <span className="rounded-full border border-green-500/30 px-2 py-1 text-[9px] font-bold tracking-[0.12em] text-green-500/70">
                          v1124
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="rounded-xl border border-green-500/30 bg-black/50 px-2 py-4 text-center">
                          <div className="text-[9px] font-black tracking-[0.12em] text-green-500">
                            CHECKED
                          </div>
                        ...
                        <div className="rounded-xl border border-yellow-500/30 bg-black/50 px-2 py-4 text-center">
                          <div className="text-[9px] font-black tracking-[0.08em] text-yellow-500">
                            MANUAL
                          </div>
                          <div className="mt-2 text-3xl font-black text-white">
                            {summary.manual}
                        ...
                        <div className="rounded-xl border border-red-500/30 bg-black/50 px-2 py-4 text-center">
                          <div className="text-[9px] font-black tracking-[0.12em] text-red-400">
                            DEFECTS
                          </div>
                          <div className="mt-2 text-3xl font-black text-white">
                            {summary.defects}
            ...
            <div className={`mt-6 grid gap-3 ${activeTab === "ULTIMATE" ? "grid-cols-1" : "sm:grid-cols-2"}`}>
              <button
                ...
                className="w-full rounded-2xl bg-gradient-to-r from-green-400 to-emerald-300 px-6 py-4 text-sm font-black tracking-[0.12em] text-black shadow-[0_0_25px_rgba(0,255,80,0.22)] transition hover:shadow-[0_0_35px_rgba(0,255,80,0.38)] disabled:cursor-not-allowed disabled:opacity-40"
              >
                ◉ &nbsp; {activeTab === "ULTIMATE"
              ...
              {activeTab !== "ULTIMATE" && (
                <button
                  ...
                  className="w-full rounded-2xl border border-green-400/60 bg-green-400/10 px-6 py-4 text-sm font-black tracking-[0.12em] text-green-300 transition hover:bg-green-400/20 hover:text-green-200 disabled:cursor-not-allowed disabled:border-green-100/30 disabled:bg-black/40 disabled:text-green-100/30"
                >
          ...
          {[
            ...
            ([
              ...
              >
                ...
                <p className="mt-3 text-sm font-black tracking-[0.12em] text-white">
                  {
                    title
                  }
                </p>

                <p className="mt-1 text-xs text-green-100/45">
                  {
                    text
                  }
                </p>
        ...
        <section className="mx-auto mt-16 max-w-4xl">
          <div className="overflow-hidden rounded-[28px] border border-cyan-400/50 bg-black/80 p-3 shadow-[0_0_40px_rgba(0,220,255,0.12)]">
            <div className="rounded-[22px] border border-cyan-400/30 bg-[#020a0d] p-7 text-center shadow-[inset_0_0_35px_rgba(0,220,255,0.05)] sm:p-10">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-xs leading-6 tracking-[0.12em] text-cyan-100/60 sm:text-sm">
                A SPECIALIZED WORKSPACE FOR AUTOMATED WEBSITE INVESTIGATION
              </p>

              <p className="mx-auto mt-3 max-w-3xl text-[10px] font-black tracking-[0.16em] text-cyan-400 sm:text-xs">
              ...
              <button
                ...
                className="mt-7 w-full rounded-2xl bg-gradient-to-r from-cyan-400 to-sky-300 px-6 py-5 text-sm font-black tracking-[0.16em] text-black shadow-[0_0_35px_rgba(0,220,255,0.28)] transition hover:scale-[1.01] hover:shadow-[0_0_50px_rgba(0,220,255,0.45)] active:scale-[0.99]"
              >
                BUG WORKSTATION
              </button>
            </div>
        ...
        <footer className="relative mt-16 border-t border-green-500/30 pt-8">
          ...
          <div className="flex items-center justify-between pt-6 text-[10px] font-bold tracking-[0.2em] text-green-500/60">
            <span>
              v1124 BUG CHECKER
            </span>
