...
type CheckerStats = {
  LINK: { runs: number; checked: number; defects: number };
  IMAGE: { runs: number; checked: number; defects: number };
  VIDEO: { runs: number; checked: number; defects: number };
  ULTIMATE: { runs: number; checked: number; defects: number };
};
      ...
      <div className="relative mx-auto min-h-screen max-w-6xl px-5 py-8 sm:px-10 sm:py-10">
        <div className="relative">
          <header className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-5 text-body font-semibold tracking-[0.14em] text-cyan-100/65">A SPECIALIZED WORKSPACE FOR AUTOMATED WEBSITE INVESTIGATION</p>
            <p className="mt-4 text-label font-black tracking-[0.16em] text-cyan-400">INVESTIGATION BROWSER &nbsp;|&nbsp; <span className="text-green-400">ULTIMATE CHECKER</span> &nbsp;|&nbsp; SIGNALS &nbsp;|&nbsp; EXTRACTORS &nbsp;|&nbsp; EVIDENCES &nbsp;|&nbsp; SOURCE HIERARCHY &nbsp;|&nbsp; PROJECT INSTRUCTION</p>
          </header>
        </div>
          ...
          <div className="mt-4 rounded-2xl border border-green-500/40 bg-green-500/[0.07] p-5 shadow-[0_0_25px_rgba(0,255,80,0.08)]">
            ...
            {statsTab === "overview" ? (
              ...
              <div className="mt-4">
                <div className="grid grid-cols-2 gap-2">
                  {([
                    ["ULTIMATE SCANS", checkerStats.ULTIMATE.runs],
                    ["TOTAL LINK CHECKS", 0],
                    ["TOTAL IMAGE CHECKS", 0],
                    ["TOTAL VIDEO CHECKS", 0],
                    ["LINK DEFECTS", 0],
                    ["IMAGE DEFECTS", 0],
                    ["VIDEO DEFECTS", 0],
                    ["LINK MANUAL", 0],
                    ["IMAGE MANUAL", 0],
                    ["VIDEO MANUAL", 0],
                    ["TOTAL CHECKED", checkerStats.ULTIMATE.checked],
                    ["TOTAL CONFIRMED DEFECTS", checkerStats.ULTIMATE.defects],
...
export default function UserPage(){ return <AuthGate returnTo="/workstation/user"><UserPageContent /></AuthGate>; }
